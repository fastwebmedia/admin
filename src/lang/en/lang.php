...
return [
	...
	'alert' => [
		'update' => [
			'success' 	   => "<h4><i class='icon fa fa-check'></i> Success!</h4> Item saved successfully. <a href=':route'>Return to listing</a>",
			'error'   	   => "<h4><i class='icon fa fa-close'></i> Error!</h4> There was an unexpected error when saving the item.",
			'validation'   => "<h4><i class='icon fa fa-exclamation'></i> Oops!</h4> Please ensure the required fields are completed.",
		]
	],
	'ckeditor' => [
		'upload'        => [
	...
	'field' => [
		'youtube' => [
			'help' => 'Enter the Youtube URL or Video ID'
		],
		'soundcloud' => [
			'help' => 'Enter SoundCloud track ID (<small>34019569</small>)'
		],
		'vine' => [
			'help' => 'Enter Vine URL or ID <small>(https://vine.co/v/M93vdMtM6hE)</small>'
		],
		'download' => [
			'body' => 'URL to file download'
		]
	]
];
