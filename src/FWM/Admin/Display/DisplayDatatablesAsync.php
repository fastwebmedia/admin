...
use Input;
use Route;
use FWM\Admin\ColumnFilters\Date;
use FWM\Admin\Columns\Column\DateTime;
use FWM\Admin\Columns\Column\NamedColumn;
use FWM\Admin\Columns\Column\FWMString;
...
class DisplayDatatablesAsync extends DisplayDatatables implements WithRoutesInterface
{
	...
	protected function applySearch($query)
	{
		...
		$query->where(function ($query) use ($search)
		{
			...
			{
				if ($column instanceof FWMString)
				{
					$name = $column->name();
