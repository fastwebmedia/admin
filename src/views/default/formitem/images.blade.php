                ...
                <div class="col-xs-12 col-sm-6 col-md-3 imageThumbnail">
                    <div class="thumbnail">
                        ...
                        <div class="text-right">
                            <button data-toggle="modal" data-target="#modal-{{ $image->id }}" class="btn btn-primary btn-sm" type="button"><i class="fa fa-expand"></i> Expand</button>
                            <button class="btn btn-danger btn-sm imageRemove" type="button"><i class="fa fa-remove"></i> Remove</button>
                        </div>
                    </div>
                </div>

                @include(AdminTemplate::view('_partials.image_modal'))
